...
(The 5th slot is one player logging under three aliases: **Decayheat** / **Neutronflux**
(both Warlock) and **Donnager** (a Demon Hunter alt — same person, different class/kit).
All three are in `config.ROSTER`.)
