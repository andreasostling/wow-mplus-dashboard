...
- Rank dungeon loot by unresolved guide-listed targets: weapons and trinkets weigh 3, jewelry and off-hands weigh 2, and armor weighs 1. Multiply DPS players' target scores by 1.5; tank and healer scores remain at 1. These targets are candidates to consider, not unconditional BiS.
...
- Which Season 2 Keystone routes should replace the historical Season 1 route and SimC fixtures?
...
2. Export and verify Season 2 Keystone routes before replacing the historical route and SimC fixtures.
