...
class TestLootCatalog(unittest.TestCase):
    ...
    def test_expected_full_priority_and_scores(self):
        ...
        self.assertEqual([(r["dungeon"], r["total_weight"], r["target_count"]) for r in rows], [
            ("Altar of Fangs", 27.5, 8), ("Murder Row", 20.5, 7), ("King's Rest", 18.5, 6),
            ("Temple of Sethraliss", 16.5, 8), ("The Blinding Vale", 16.5, 7),
            ("Voidscar Arena", 15.5, 5), ("Ruby Life Pools", 14, 7), ("Den of Nalorakk", 10, 5),
        ])
    ...
    def test_dps_targets_receive_one_point_five_role_multiplier(self):
        ...
        self.assertEqual((gaddini["role"], gaddini["base_weight"], gaddini["role_multiplier"], gaddini["remaining_weight"]),
                         ("dps", 3, 1.5, 4.5))
    ...
    def test_exact_item_name_selector_filters_owned(self):
        ...
        self.assertEqual(row["total_weight"], 14)
